...
class StoreKpiReportRequest extends FormRequest
{
    /**
    ...
    {
        return auth()->check() && (auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('kpi_reports', 'create'));
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => 'nullable|in:pending,pending_approval,on_progress,completed,cancelled',
        ];
    }
    ...
    {
        return [
            'application_id.required' => 'Nama Aplikasi wajib dipilih.',
